...
def start_server():
    ...
    # Disable simulation to rely on actual logic or mock safely
...
# ==============================================================================
# GROUP 1: SYSTEM TOP BAR & DATA CONNECTIONS (Tests 1-5)
# ==============================================================================
def test_01_page_loads_with_correct_title(page: Page):
    page.goto("http://127.0.0.1:8002")
    expect(page).to_have_title("SuperNova")
...
def test_29_chart_adx_pane_exists(page: Page):
    ...
    page.evaluate("openChart('INFY')")
    expect(page.locator("#legend-ltp")).to_contain_text("LTP:", timeout=20000)
    expect(page.locator("#adx-container canvas")).to_be_visible()
